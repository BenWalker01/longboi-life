...
public class GamePreferences {
  ...
  private static final String KEYBOARD_BINDING_PAUSE = "keyboard.bindings.pause";
  ...
  public static int getKeyboardBindingPause() {
    return prefs.getInteger(KEYBOARD_BINDING_PAUSE, 62);
  }

  public static void setKeyboardBindingPause(int key) {
    prefs.putInteger(KEYBOARD_BINDING_PAUSE, key);
    prefs.flush();
  }
